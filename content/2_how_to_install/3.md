...
프로그램을 설치하면 거래정보를 텔레그램으로 받아볼수 있습니다.
...
윈도우 사용자 : [Windows 사용자](http://www.telegram.pe.kr)

MAC 사용자 : [MAC 사용자](https://play.google.com/store/apps/details?id=org.telegram.messenger&hl=ko)



 

해당 링크를 실행하여 텔레그램에 접속합니다.
